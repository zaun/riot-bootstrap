...
riot.tag2('icon-battery', '<span title="{name}" data-author="{author}" data-license="{license}" data-origial="{url}"> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="{viewbox}"> <g> <path riot-d="{path}"></path> </g> </svg> </span>', 'icon-battery,[riot-tag="icon-battery"],[data-is="icon-battery"]{ display: inline-block; width: 1em; height: 1em; } icon-battery svg,[riot-tag="icon-battery"] svg,[data-is="icon-battery"] svg{ display: inline-block; width: 1em; height: 1em; }', '', function (opts) {
  var _this = this;
