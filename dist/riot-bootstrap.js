(function (riot) {
	...
	riot.tag2('badge', '<yield></yield>', 'badge,[riot-tag="badge"],[data-is="badge"]{ display: inline-block; min-width: 1.1em; padding: 0 0.5em; font-size: inherit; line-height: 1; height: 1em; color: #fff; text-align: center; white-space: nowrap; background-color: #777; border-radius: 10px; box-sizing: border-box; } badge[option="primary"],[riot-tag="badge"][option="primary"],[data-is="badge"][option="primary"]{ background-color: #337ab7; } badge[option="success"],[riot-tag="badge"][option="success"],[data-is="badge"][option="success"]{ background-color: #5cb85c; } badge[option="info"],[riot-tag="badge"][option="info"],[data-is="badge"][option="info"]{ background-color: #5bc0de; } badge[option="warning"],[riot-tag="badge"][option="warning"],[data-is="badge"][option="warning"]{ background-color: #f0ad4e; } badge[option="danger"],[riot-tag="badge"][option="danger"],[data-is="badge"][option="danger"]{ background-color: #d9534f; } badge[data-parent-option="primary"],[riot-tag="badge"][data-parent-option="primary"],[data-is="badge"][data-parent-option="primary"]{ color: #337ab7; background-color: #fff; } badge[data-parent-option="success"],[riot-tag="badge"][data-parent-option="success"],[data-is="badge"][data-parent-option="success"]{ color: #5cb85c; background-color: #fff; } badge[data-parent-option="info"],[riot-tag="badge"][data-parent-option="info"],[data-is="badge"][data-parent-option="info"]{ color: #5bc0de; background-color: #fff; } badge[data-parent-option="warning"],[riot-tag="badge"][data-parent-option="warning"],[data-is="badge"][data-parent-option="warning"]{ color: #f0ad4e; background-color: #fff; } badge[data-parent-option="danger"],[riot-tag="badge"][data-parent-option="danger"],[data-is="badge"][data-parent-option="danger"]{ color: #d9534f; background-color: #fff; }', '', function (opts) {
	  var _this = this;

	  this.mixin(parentScope).mixin(domEvent);

	  this.on('update', function (e) {
	    if (_this.parent && _this.parent.root.hasAttribute("option")) {
	      _this.root.setAttribute("data-parent-option", _this.parent.root.getAttribute("option"));
	    } else {
	      _this.root.removeAttribute("data-parent-option");
	    }
	    if (_this.parent && _this.parent.root.hasAttribute("size")) {
	      _this.root.setAttribute("data-parent-size", _this.parent.root.getAttribute("size"));
	    } else {
	      _this.root.removeAttribute("data-parent-size");
	    }
	  });
	});
